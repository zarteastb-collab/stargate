...
// Remove the explicit app.get('/') route here, express.static will handle serving index.html
// if it's directly in the public directory and a root path is requested.
